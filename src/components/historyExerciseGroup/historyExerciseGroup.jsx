        ...
        <>
          <tr
            ...
            className={`text-xl ${styles.tableRow} relative ${
              set == 1 && !workout.exercises[exercise][set].completed
                ? "dark:bg-red-600 dark:bg-opacity-50 bg-red-300"
                : !workout.exercises[exercise][set].completed
                ? "dark:bg-red-950 bg-red-100"
                : set == 1
                ? "bg-cardBG"
